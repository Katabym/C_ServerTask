...
int main() {
    ...
    // Создаем подписку на топик от первого приложения
    natsSubscription* sub = nullptr;
    natsConnection_Subscribe(&sub, conn, "app1_tick", handler, nullptr);
    ...
    while (true) {
        ...
        natsConnection_PublishString(conn, "app2_tick", to_string(t_rounded).c_str());
